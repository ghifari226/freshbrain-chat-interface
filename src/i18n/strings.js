...
export const strings = {
  ...
  auth: {
    ...
    roleSuperadmin: { id: 'Superadmin', en: 'Superadmin' },
    roleLogisticManager: { id: 'Logistic Manager', en: 'Logistic Manager' },
    roleFinance: { id: 'Finance', en: 'Finance' },
    roleTechnology: { id: 'Technology', en: 'Technology' },
    roleClientServiceManagement: {
      id: 'Client Service Management',
      en: 'Client Service Management',
    },
    roleHumanResource: { id: 'Human Resource', en: 'Human Resource' },
  ...
  config: {
    ...
    addPermission: { id: 'Tambah hak akses', en: 'Add permission' },
    editPermission: { id: 'Ubah hak akses', en: 'Edit permission' },
    permissionKeyLabel: { id: 'Key', en: 'Key' },
    permissionKeyPlaceholder: { id: 'contoh: reports.view', en: 'e.g. reports.view' },
    permissionGroupLabel: { id: 'Grup', en: 'Group' },
    permissionLabelLabel: { id: 'Label', en: 'Label' },
  ...
  permissions: {
    ...
    permissionAdd: { id: 'Permission — Add', en: 'Permission — Add' },
