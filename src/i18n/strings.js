...
export const strings = {
  ...
  config: {
    ...
    rolesDesc: {
      ...
      id: 'Aktifkan/nonaktifkan scope yang dapat diakses tiap peran. Perubahan di sini hanya berlaku untuk sesi ini dan belum disimpan ke backend.',
    },
