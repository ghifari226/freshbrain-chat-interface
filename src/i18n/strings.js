...
export const strings = {
  ...
  permissions: {
    ...
    toolLiveView: { id: 'Tools — Live View', en: 'Tools — Live View' },
    toolRequestView: { id: 'Tools — Request View', en: 'Tools — Request View' },
    toolRequestAdd: { id: 'Tools — Request Add', en: 'Tools — Request Add' },
    toolRequestEdit: { id: 'Tools — Request Edit', en: 'Tools — Request Edit' },
    toolRequestChangeStatus: { id: 'Tools — Request Change Status', en: 'Tools — Request Change Status' },
  ...
  freshpedia: {
    ...
    postRequestAction: { id: 'Posting', en: 'Post' },
    moveToDraftAction: { id: 'Kembalikan ke Draft', en: 'Move to Draft' },
  },
  toolCatalog: {
