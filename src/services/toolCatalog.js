...
const MOCK_TOOLS = [
  ...
  {
    id: 'a2f6b3c1-0000-4e11-8b22-000000000010',
    system: 'wms',
    name: 'labor',
    status: 'production',
    createdBy: GHIFARI_UID,
    ...
    description: 'Melihat produktivitas dan alokasi tenaga kerja gudang.',
    exampleQuestions: [
      'Berapa jumlah pekerja aktif di gudang X hari ini?',
      'Bagaimana produktivitas tim picking minggu ini?',
    ],
  },
  {
    id: 'a2f6b3c1-0000-4e11-8b22-000000000011',
    system: 'wms',
    name: 'warehouse',
    status: 'production',
    createdBy: GHIFARI_UID,
    ...
    description: 'Melihat data umum gudang, termasuk kapasitas dan lokasi.',
    exampleQuestions: [
      'Berapa kapasitas gudang X saat ini?',
      'Gudang mana saja yang beroperasi di wilayah Jawa Timur?',
    ],
  },
  {
  ...
  {
    id: 'a2f6b3c1-0000-4e11-8b22-000000000012',
    system: 'tms',
    name: 'trip',
    status: 'production',
    createdBy: GHIFARI_UID,
    ...
    description: 'Melihat data perjalanan armada pengiriman.',
    exampleQuestions: [
      'Berapa banyak trip yang sedang berjalan hari ini?',
      'Armada mana yang belum menyelesaikan trip-nya?',
    ],
  },
  {
  ...
  {
    id: 'a2f6b3c1-0000-4e11-8b22-000000000013',
    system: 'dwh',
    name: 'daily_fulfillment',
    status: 'request',
    requestStatus: 'draft',
    createdBy: GHIFARI_UID,
    ...
    description: 'Melihat ringkasan fulfillment harian dari data warehouse.',
    exampleQuestions: [
      'Berapa total fulfillment hari ini?',
      'Bagaimana tren fulfillment harian minggu ini?',
    ],
  },
]
